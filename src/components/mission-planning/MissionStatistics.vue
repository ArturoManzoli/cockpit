...
import { useBlueBoatMissionEstimates } from '@/libs/mission/blueboat-estimates'
...
const { totalMissionLength, totalSurveyCoverage } = useMissionStats()
const { timeToCompleteMission, totalEnergy } = useBlueBoatMissionEstimates()
