...
watch(home, () => {
  ...
  if (!homeMarker.value) {
    ...
    const homeMarkerTooltip = L.tooltip({
      content: '<i class="mdi mdi-home-map-marker text-[18px] border-[2px] rounded-full"></i>',
      permanent: true,
      direction: 'center',
      className: 'waypoint-tooltip',
      opacity: 1,
...
const setDefaultMapPosition = async (): Promise<void> => {
  ...
  try {
    ...
    const tempTooltip = L.tooltip({
      content: '<i class="mdi mdi-map-check text-[16px] border-[2px] rounded-full p-[2px]"></i>',
      permanent: true,
      direction: 'center',
      className: 'waypoint-tooltip',
      opacity: 1,
...
const executeGoToOption = (): void => {
  ...
  const gotoTooltip = L.tooltip({
    content: '<i class="mdi mdi-send-circle-outline text-[28px]"></i>',
    permanent: true,
    direction: 'center',
    className: 'waypoint-tooltip',
    opacity: 1,
