        ...
        <div v-if="showMainMenu" ref="mainMenu" class="left-menu slide-in">
          <v-window v-model="mainMenuStep" class="h-full w-full">
            <v-window-item :value="1" class="h-full">
              <div class="flex flex-col pt-5 pb-6 h-full justify-between gap-y-10">
                <GlassButton
                ...
                <GlassButton
                  ...
                  :width="buttonSize"
                  icon="mdi-send"
                  icon-class="2xl:mt-[1px] 2xl:ml-[5px] xl:mt-[1px] xl:ml-[4px] lg:mt-[2px] lg:ml-[3px] md:mt-[1px] md:ml-[5px] sm:mt-[1px] sm:ml-[1px] mt-[1px] ml-[1px]"
                  :disabled="false"
                ...
                <GlassButton
                  ...
                  icon-class="2xl:mt-[1px] 2xl:ml-[3px] xl:mt-[1px] xl:ml-[2px] lg:mt-[2px] lg:ml-[3px] md:mt-[1px] md:ml-[2px] sm:mt-[1px] sm:ml-[1px] mt-[1px] ml-[1px]"
                  variant="round"
                  :width="buttonSize"
                  :disabled="false"
                  :selected="false"
            ...
            <v-window-item :value="2" class="h-full w-full">
              <div class="flex flex-col pb-2 w-full h-full justify-between gap-y-1">
                <GlassButton
                  label="General"
                  :label-class="menuLabelSize"
                  icon="mdi-view-dashboard-variant"
                  icon-class="-mb-3 2xl:mt-[2px] 2xl:ml-[2px] xl:mt-[1.5px] xl:ml-[1px] lg:mt-[2px] lg:ml-[2px] md:mt-[1px] md:ml-[1px] sm:mt-[0.5px] sm:ml-[1px] mt-[1px] ml-[1px]"
                  variant="uncontained"
                  no-glass
                ...
                <GlassButton
                  ...
                  icon-class="-mb-2 2xl:mt-[2px] 2xl:ml-[2px] xl:mt-[1.5px] xl:ml-[1px] lg:mt-[2px] lg:ml-[2px] md:mt-[1px] md:ml-[1px] sm:mt-[0.5px] sm:ml-[1px] mt-[1px] ml-[1px]"
                  variant="uncontained"
                  no-glass
                  :height="buttonSize * 0.5"
                  :icon-size="buttonSize * 0.6"
                ...
                <div class="flex flex-col justify-center align-center">
                  ...
                  <GlassButton
                    :label-class="menuLabelSize"
                    icon="mdi-arrow-left"
                    icon-class="xl:mt-[2px] xl:ml-[1px] lg:mt-[2px] lg:ml-[1px] md:mt-[1px] md:ml-[1px] sm:mt-[0.5px] sm:ml-[1px] mt-[1px] ml-[1px]"
                    variant="round"
